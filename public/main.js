...
const CHARGED_OFF_EXAMPLE = {
  ...
  total_acc: 52,
  collections_12_mths_ex_med: 0,
  inv_mths_since_last_major_derog: 55,
  application_type: "Individual",
  annual_inc_joint: "N/A",
  dti_joint: "N/A",
  acc_now_delinq: 0,
  ...
  mo_sin_old_rev_tl_op: 76,
  inv_mo_sin_rcnt_rev_tl_op: 3,
  inv_mo_sin_rcnt_tl: 2,
  mort_acc: 0,
  inv_mths_since_recent_bc: 7,
  inv_mths_since_recent_bc_dlq: "N/A",
  inv_mths_since_recent_inq: 1,
  inv_mths_since_recent_revol_delinq: 55,
  ...
  pub_rec_bankruptcies: 0,
  tax_liens: 0,
  tot_hi_cred_lim: 77071,
  total_bal_ex_mort: 73607,
  total_bc_limit: 2700,
  total_il_high_credit_limit: 70571,
};
  ...
  $("#apiTest").submit(function () {
    ...
    $.ajax({
      ...
      complete: function (response) {
        $("#apiOutput").text(JSON.stringify(response.responseJSON, null, 2));
